...
test.describe('Admin Users Management', () => {
  ...
  test('can create, deactivate, activate, and edit a user', async ({ page }) => {
    ...
    const actionsTrigger = row
      .locator('[data-testid="row-actions"], button:has(svg), .dropdown-trigger, .action-button, button:has-text("Open menu")')
      .first();
    ...
    await Promise.all([waitForGraphQLOperation(page, 'UpdateUserStatus'), deactivateButton.click()]);
    ...
    await Promise.all([waitForGraphQLOperation(page, 'UpdateUserStatus'), activateButton.click()]);
    ...
    await Promise.all([waitForGraphQLOperation(page, 'UpdateUser'), saveButton.click()]);
