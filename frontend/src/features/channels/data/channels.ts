  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        handleError(error, m["channels.errors.fetchPrices"]());
        throw error;
      }
    },
    enabled: !!channelId,
...
export function useSaveChannelModelPrices() {
  ...
  return useMutation({
    ...
    onSuccess: (_, variables) => {
      ...
      toast.success(m["channels.messages.savePricesSuccess"]());
    },
    onError: (error) => {
      toast.error(m["channels.messages.savePricesError"]({ error: error.message }));
    },
  });
}
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        handleError(error, m["channels.errors.fetchList"]());
        throw error;
      }
    },
  });
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        handleError(error, m["channels.errors.fetchNames"]());
        throw error;
      }
    },
...
export function useCreateChannel() {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success(m["channels.messages.createSuccess"]());
    },
    onError: (error) => {
      toast.error(m["channels.messages.createError"]({ error: error.message }));
    },
  });
}
...
export function useBulkCreateChannels() {
  ...
  return useMutation({
    ...
    onSuccess: (channels) => {
      queryClient.invalidateQueries({ queryKey: ['channels'] });
      toast.success(m["channels.messages.batchCreateSuccess"]({ count: channels.length }));
    },
    onError: (error) => {
      toast.error(m["channels.messages.batchCreateError"]({ error: error.message }));
    },
  });
}
...
export function useUpdateChannel() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast.error(m["channels.messages.updateError"]({ error: error.message }));
    },
  });
}
...
export function useBulkArchiveChannels() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, variables) => {
      queryClient.invalidateQueries({ queryKey: ['channels'] });
      toast.success(m["channels.messages.bulkArchiveSuccess"]({ count: variables.length }));
    },
    onError: (error) => {
      toast.error(m["channels.messages.bulkArchiveError"]({ error: error.message }));
    },
  });
}
...
export function useBulkDisableChannels() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, variables) => {
      queryClient.invalidateQueries({ queryKey: ['channels'] });
      toast.success(m["channels.messages.bulkDisableSuccess"]({ count: variables.length }));
    },
    onError: (error) => {
      toast.error(m["channels.messages.bulkDisableError"]({ error: error.message }));
    },
  });
}
...
export function useBulkEnableChannels() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, variables) => {
      queryClient.invalidateQueries({ queryKey: ['channels'] });
      toast.success(m["channels.messages.bulkEnableSuccess"]({ count: variables.length }));
    },
    onError: (error) => {
      toast.error(m["channels.messages.bulkEnableError"]({ error: error.message }));
    },
  });
}
...
export function useDeleteChannel() {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['channels'] });
      toast.success(m["channels.messages.deleteSuccess"]());
    },
    onError: (error) => {
      toast.error(m["channels.messages.deleteError"]({ error: error.message }));
    },
  });
}
...
export function useBulkDeleteChannels() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, variables) => {
      queryClient.invalidateQueries({ queryKey: ['channels'] });
      toast.success(m["channels.messages.bulkDeleteSuccess"]({ count: variables.length }));
    },
    onError: (error) => {
      toast.error(m["channels.messages.bulkDeleteError"]({ error: error.message }));
    },
  });
}
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      if (data.success) {
        ...
        const errorMsg = data.error || m["channels.messages.testUnknownError"]();
        toast.error(m["channels.messages.testError"]({ error: errorMsg }));
      }
    },
    onError: (error) => {
...
export function useBulkImportChannels() {
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      ...
      if (data.success) {
        toast.success(
          m["channels.messages.bulkImportSuccess"]({
            created: data.created })
        );
      } else {
        toast.error(
          m["channels.messages.bulkImportPartialError"]({
            created: data.created,
            failed: data.failed })
        );
      }
    ...
    onError: (error) => {
      toast.error(m["channels.messages.bulkImportError"]({ error: error.message }));
    },
  });
}
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        handleError(error, m["channels.errors.fetchOrdering"]());
        throw error;
      }
    },
...
export function useBulkUpdateChannelOrdering() {
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast.success(
        m["channels.messages.orderingUpdateSuccess"]({
          updated: data.updated })
      );
    },
    onError: (error) => {
      toast.error(m["channels.messages.orderingUpdateError"]({ error: error.message }));
    },
  });
}
...
export function useSyncChannelModels() {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['channels'] });
      toast.success(m["channels.messages.syncModelsSuccess"]());
    },
    onError: (error) => {
      toast.error(m["channels.messages.syncModelsError"]({ error: error.message }));
    },
  });
}
...
export function useFetchModels() {
  return useMutation({
    ...
    onSuccess: (data) => {
      if (data.error) {
        toast.error(m["channels.messages.fetchModelsError"]({ error: data.error }));
      } else {
        const count = data.models.length;
        if (count > 100) {
          toast.success(m["channels.messages.fetchModelsSuccessLarge"]({ count }));
        } else {
          toast.success(m["channels.messages.fetchModelsSuccess"]({ count }));
        }
      }
    },
    onError: (error) => {
      toast.error(m["channels.messages.fetchModelsError"]({ error: error.message }));
    },
  });
}
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        handleError(error, m["channels.errors.fetchTypes"]());
        throw error;
      }
    },
    staleTime: 5 * 60 * 1000, // 5 minutes
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        handleError(error, m["channels.errors.fetchTags"]());
        throw error;
      }
    },
    staleTime: 5 * 60 * 1000, // 5 minutes
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        handleError(error, m["channels.errors.fetchProbeData"]());
        return [];
      }
    },
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        handleError(error, m["channels.errors.fetchDisabledAPIKeys"]());
        return [];
      }
    },
...
export function useEnableChannelAPIKey() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, variables) => {
      ...
      queryClient.invalidateQueries({ queryKey: ['channels'] });
      toast.success(m["channels.messages.enableAPIKeySuccess"]());
    },
    onError: (error) => {
      toast.error(m["channels.messages.enableAPIKeyError"]({ error: error.message }));
    },
  });
}
...
export function useEnableAllChannelAPIKeys() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, variables) => {
      queryClient.invalidateQueries({ queryKey: ['channelDisabledAPIKeys', variables.channelID] });
      queryClient.invalidateQueries({ queryKey: ['channels'] });
      toast.success(m["channels.messages.enableAllAPIKeysSuccess"]());
    },
    onError: (error) => {
      toast.error(m["channels.messages.enableAllAPIKeysError"]({ error: error.message }));
    },
  });
}
...
export function useEnableSelectedChannelAPIKeys() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, variables) => {
      queryClient.invalidateQueries({ queryKey: ['channelDisabledAPIKeys', variables.channelID] });
      queryClient.invalidateQueries({ queryKey: ['channels'] });
      toast.success(m["channels.messages.enableSelectedAPIKeysSuccess"]());
    },
    onError: (error) => {
      toast.error(m["channels.messages.enableSelectedAPIKeysError"]({ error: error.message }));
    },
  });
}
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      if (data.message === 'ONE_KEY_PRESERVED') {
        toast.success(m["channels.messages.deleteDisabledAPIKeysPreserved"]());
      } else {
        toast.success(m["channels.messages.deleteDisabledAPIKeysSuccess"]());
      }
    },
    onError: (error) => {
      toast.error(m["channels.messages.deleteDisabledAPIKeysError"]({ error: error.message }));
    },
  });
}
