...
export function DateTimeRangePicker(props: DateTimeRangePickerProps) {
  ...
  const range: DateRange | undefined = internal.from || internal.to ? { from: internal.from, to: internal.to } : undefined;
  ...
  return (
    ...
    >
      <div className='flex items-center justify-between border-b border-gray-100 bg-white p-4 dark:border-white/5 dark:bg-[#0a0a0b]/50'>
        <div className={cn(buttonVariants({ variant: 'outline', size: 'sm' }), 'h-8 cursor-default border-solid')}>
      ...
      <div className='flex flex-col gap-8 bg-white p-6 md:flex-row dark:bg-[#0a0a0b]'>
