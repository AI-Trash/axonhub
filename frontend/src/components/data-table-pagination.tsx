  ...
  return (
    <div className='flex items-center justify-between overflow-clip px-2' style={{ overflowClipMargin: 1 }}>
      <div className='text-muted-foreground hidden flex-1 text-sm sm:block'>
        {m["pagination.selectedRows"]({ selected: selectedRows, total: totalRows })}
      </div>
      <div className='flex items-center sm:space-x-6 lg:space-x-8'>
        ...
        <div className='flex items-center justify-center text-sm font-medium'>
          <div className='flex items-center space-x-1'>{m["pagination.currentPage"]({ current: currentPage, total: totalPages })}</div>
        </div>
        <div className='flex items-center space-x-2'>
          <Button
            variant='outline'
